...
const Home = async () => {
  ...
  const images = [
    {
      title: "おりじなりてぃ",
      description: "もんたの森の絵は癖が強くて他と被らない",
      src: "/top-yahhoi.png",
      alt: "おりじなりてぃのある画像",
    },
    {
      title: "ゆるいでざいん",
      description: "もんたの森ではゆーるいデザインを大切にしています",
      src: "/top-normal.png",
      alt: "ゆるいでざいんな画像",
    },
    {
      title: "つかえるばめんがおおい",
      description: "使える場面の多いイラストを描くことを心がけています",
      src: "/top-sumasenn.png",
      alt: "つかえるばめんがおおい画像",
    },
    {
      title: "くせつよもある",
      description: "にっちな場面でしか使えないイラストも描いています",
      src: "/top-nikuway.png",
      alt: "くせつよもあるな画像",
    },
  ];
        ...
        <div className="max-w-[1100px] m-auto px-12">
          <div className="border-t border-gray-200 py-12 flex flex-wrap">
            {sns.map((s, index) => (
              ...
              >
                <Image className="image mx-1 group-hover:opacity-70" alt={s.name} src={s.src} fill />
